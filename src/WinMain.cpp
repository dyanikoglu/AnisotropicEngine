...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, PSTR szCmdLine, int iCmdShow) {
	...
	wndclass.lpszClassName = TEXT("Anisotropic Engine");
	...
	HWND hwnd = CreateWindowEx(0, wndclass.lpszClassName, TEXT("Anisotropic Engine"), style, windowRect.left, windowRect.top, windowRect.right - windowRect.left, windowRect.bottom - windowRect.top, NULL, NULL, hInstance, szCmdLine);
	HDC hdc = GetDC(hwnd);
	...
	case WM_CLOSE:
		{
			...
			{
				std::cout << "Warning: Already shut down!\n";
			}
		}
		break;
	case WM_DESTROY:
		{
			...
			{
				std::cout << "Warning: Multiple destroy messages received!\n";
			}
			break;
		}
	case WM_PAINT:
